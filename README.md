...
- 📝 偶尔在 [博客地址](https://byte-wrangler.github.io/) 分享技术心得
...
**技术栈**: Spring Cloud, Nacos, Gateway, Feign, Sentinel  
**亮点**:
- 🌐 微服务架构设计，支持动态扩缩容
- 🛡️ 集成了熔断降级和限流机制
- 📊 实现了分布式链路追踪
...
**技术栈**: Spring Boot, Elasticsearch, Kafka, Docker  
**亮点**:
- 🔍 基于ES的全文检索系统
- 📨 实时数据同步方案
- 🚀 容器化部署，支持CI/CD
